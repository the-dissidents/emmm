...
import { ParseContext, ModifierNode, BlockModifierDefinition, InlineModifierDefinition, ModifierFlags } from "../interface";
...
export function customModifier<T extends 'inline' | 'block'>(type: T,
