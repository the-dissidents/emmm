<script lang="ts">
  ...
  import { ListView, type ListButtonCell, type ListCell, type ListColumn, type ListItem, type ListViewHandleIn, type ListViewHandleOut } from '$lib/ui';
  import { SvelteMap } from 'svelte/reactivity';
  import { Weixin } from '$lib/features/weixin';
  import { Interface } from '$lib/core';
  import { getIP, GetIPMethod, loadImage } from '$lib/utils';
  import { RustAPI } from "$lib/utils";
  import { path } from "@tauri-apps/api";
  import { tempDir } from "@tauri-apps/api/path";
  import { convertFileSrc } from "@tauri-apps/api/core";
  import * as clipboard from '@tauri-apps/plugin-clipboard-manager';
  import { postprocess } from "$lib/features/weixin";
