<script lang="ts">
  ...
  import { setEditorContext } from "$lib/components";
  import type { Snippet } from "svelte";
  import { emmmDocument, type ContextProvider, type DescriptorProvider, type EmmmParseData } from "$lib/features/editor";
  import { emmmLanguageSupport } from "$lib/features/editor";
